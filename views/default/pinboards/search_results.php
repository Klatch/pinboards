...
if (!elgg_instanceof($entity)) {
  echo elgg_echo('pinboards:error:invalid:entity');
  return;
}
...
$write_accesses = pinboards_get_write_accesses($user);
...
$options['wheres'][] = "NOT EXISTS ( SELECT 1 FROM {$dbprefix}entity_relationships WHERE guid_two = e.guid AND guid_one = {$entity->guid} AND relationship = '" . PINBOARDS_PINNED_RELATIONSHIP . "' )";
 * 
 */

// prevent a pinboard from pinning itself
